...
async def test_final_image_upload():
    ...
    try:
        ...
        result = await client.execute_query(verification_query, {"id": approved_product.shopify_product_id})
        ...
        if result and "data" in result and result["data"]["product"]:
            ...
            if actual_images == expected_images:
                ...
                print(f"   ⚠️ PARTIAL SUCCESS: {actual_images}/{expected_images} images uploaded")
