...
async def test_productset_api():
    ...
    try:
        ...
        test_product = db.query(SecondHandProduct).filter(
        ...
        if not test_product:
            print("❌ No suitable test product found. Need an approved and verified product without Shopify ID.")
            return
        ...
        if shopify_id:
            ...
            if client:
                ...
                result = await client.execute_query(verification_query, {"id": shopify_id})
